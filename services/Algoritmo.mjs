...
function A_EstrellaRuta(idNodoInicio, idNodoDestino, factorPeligro) {
    ...
    while (!frontera.isEmpty()) {
        ...
        if (nodo == nodoDestino) { return trayectoRecorrido; }
        ...
        nodo['rutas'].forEach(idRutaConectadaANodo => {
            ...
            conjuntoVias[idRutaConectadaANodo]['nodes'].forEach(idNodoNuevo => {
                ...
                if (explorados[idNodoNuevo] == null) {
                    ...
                    let heuristicaPeligro = distanciaNodoNuevo * nivelPeligroRuta * factorPeligro;
                    ...
                    let heuristica = distanciaRecorrida + distanciaObjetivo + distanciaNodoNuevo + heuristicaPeligro;
...
function NodeIDCoordenada(coordenada) {
    ...
    conjuntoPuntos.forEach(punto => {
        distancia = (Math.pow(punto[0] - coordenada[0], 2) + Math.pow(punto[1] - coordenada[1], 2))
